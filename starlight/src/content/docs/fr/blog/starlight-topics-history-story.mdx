...
Vous pourriez penser que cette histoire est maintenant terminée puisque tout le monde pourrait simplement utiliser la variante qu’il souhaite, tout le monde est content. Mais Starlight a continué et continue de s’améliorer, et environ trois mois plus tard, le 15 février, presque comme un [cadeau d’anniversaire](../../blog/20th-birthday/) pour moi, est venu l’ajout tant attendu des données de route dans Starlight avec la sortie de [v0.32](https://github.com/withastro/starlight/releases/tag/@astrojs/starlight@0.32.0). Cette addition apparemment petite a ouvert tant de possibilités, que je n'avais moi-même jamais envisagées. HiDeoo a une fois de plus été la source d'inspiration principale pour les auteurs de plugins et a poussé cette nouvelle fonctionnalité à ses limites. Il leur a fallu seulement deux jours pour [adapter plus de 11 plugins à la dernière version de Starlight à l’époque](https://bsky.app/profile/hideoo.dev/post/3liffpudc5c2b), et ils ont ensuite amélioré et refactoré une grande partie du code pour tirer encore plus parti de cette puissante fonctionnalité.
