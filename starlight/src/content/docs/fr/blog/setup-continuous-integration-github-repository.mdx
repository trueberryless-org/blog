...
Ce post suppose également que vous utilisez [GitHub](https://github.com/github) Actions combiné avec Argo CD pour déployer vos applications sur un cluster Kubernetes. Suivez nos autres [articles sur le déploiement](/fr/blog/tags/deployment) pour des instructions supplémentaires sur la façon de configurer ces deux technologies sur votre serveur personnel.
