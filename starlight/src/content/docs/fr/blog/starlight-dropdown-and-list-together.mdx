...
description: Découvrez comment combiner une liste de bureau et un menu déroulant
  mobile pour vos sujets de barre latérale Starlight.
date: 2025-05-13
tags:
  - Starlight
  - Components
...
excerpt: Combinez deux plugins Starlight Sidebar Topics pour afficher une liste
  de sujets sur un bureau et un menu déroulant dans la barre latérale mobile.
authors:
  - hideoo
  - trueberryless
cover:
...
Dans le guide d'installation du composant dropdown, vous avez créé un composant de barre latérale qui n'affiche que le menu déroulant. Maintenant, vous devez modifier ce composant pour qu'il affiche aussi la barre latérale par défaut si l'utilisateur est sur un bureau.
...
![Résultat final avec vue de bureau à gauche et vue mobile à droite](../../../../assets/dropdown-or-list.png)
...
De plus, vous pourriez également créer votre propre composant d'affichage, qui utilise les données de route du plugin Starlight Sidebar Topics et rend les sujets d'une manière personnalisée. C'est un peu plus avancé, mais vous pouvez trouver plus d'informations sur cela dans la documentation ["Custom Topics List"](https://starlight-sidebar-topics.netlify.app/docs/guides/custom-topic-list/).
