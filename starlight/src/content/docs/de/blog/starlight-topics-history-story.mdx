...
Sie könnten denken, dass diese Geschichte jetzt zu Ende ist, weil jeder einfach die gewünschte Variante nutzen und glücklich sein könnte. Aber Starlight hat sich weiterentwickelt und verbessert sich stetig. Etwa drei Monate später, am 15. Februar, quasi als [Geburtstagsgeschenk](../../blog/20th-birthday/) für mich, wurde die lang ersehnte Funktion für Routendaten mit der Veröffentlichung von [v0.32](https://github.com/withastro/starlight/releases/tag/@astrojs/starlight@0.32.0) in Starlight hinzugefügt. Diese scheinbar kleine Ergänzung eröffnete so viele Möglichkeiten, die ich selbst nicht kommen sah. HiDeoo war erneut die führende Inspiration für Plugin-Autoren und schöpfte dieses neue Feature bis an die Grenzen aus. Es dauerte nur zwei Tage, bis sie [über 11 Plugins an die neueste Starlight-Version anpassten](https://bsky.app/profile/hideoo.dev/post/3liffpudc5c2b), und später verbesserten und überarbeiteten sie viel vom Code, um dieses leistungsstarke Feature noch besser zu nutzen.
