...
Sie können auch [FrostyBee's](https://github.com/frostybee) [Starlight Scroll To Top-Plugin](https://github.com/frostybee/starlight-scroll-to-top) ausprobieren, das seit der Version `0.3.1` auch einen integrierten [Progress Ring](https://frostybee.github.io/starlight-scroll-to-top/configuration/#showprogressring) unterstützt. 🙌
