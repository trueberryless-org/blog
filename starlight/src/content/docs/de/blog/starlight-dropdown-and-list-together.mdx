...
Anschließend folgen Sie den Setup-Anleitungen von [Starlight Sidebar Topics](https://starlight-sidebar-topics.trueberryless.org/docs/getting-started/#installation) und [Starlight Sidebar Topics Dropdown](https://starlight-sidebar-topics-dropdown.trueberryless.org/docs/getting-started/#installation).
...
![Endgültiges Ergebnis mit der Desktop-Ansicht links und der mobilen Ansicht rechts](../../../../assets/dropdown-or-list.png)
