---
title: Dropdown on mobile, List on desktop
date: 2025-05-13
tags:
    - Starlight
    - Composition
    - Topics
    - Plugins
excerpt: Combine two Starlight Sidebar Topics plugins to create different displays on mobile and desktop.
authors:
    - trueberryless
cover:
  alt: A beautiful cover image with the text "Dropdown or List?"
  image: ../../../assets/covers/dropdownorlist.png
---
