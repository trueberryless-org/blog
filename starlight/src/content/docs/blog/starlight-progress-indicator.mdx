...
tags:
    ...
    - Components
    - CSS
excerpt: Learn how to create a horizontal progress indicator for your <a class="gh-badge" href="https://github.com/withastro/starlight"><img src="/starlight.png" alt="Starlight" width="16" height="16" style="border-radius:9999px;vertical-align:middle;margin-right:0.4em;" />Starlight</a> site.
authors:
    - frostybee
    - trueberryless
cover:
