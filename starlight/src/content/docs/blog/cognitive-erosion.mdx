...
I pointed out the main drawbacks of using AI too extensively which I observed. I will now give you two more smaller reasons, which I have noticed in myself, why you should not use AI for expressive work.
...
- Do not fall for all the shiny AI stuff out there. Tools like [Lovable](https://lovable.dev), [GitHub Copilot](https://github.com/features/copilot), [Cursor](https://cursor.com/en), [ChatGPT Voice](https://openai.com/index/chatgpt-can-now-see-hear-and-speak/), just to name a few, do not want to actually help you. They want either directly your data, or own your workflow so you can not escape once you got used to it. Unfortunately, people get used to AI fascinatingly fast.
