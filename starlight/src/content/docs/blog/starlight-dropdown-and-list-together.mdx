...
tags:
    ...
    - Plugins
    - CSS
excerpt: Combine two <a class="gh-badge" href="https://github.com/withastro/starlight"><img src="/starlight.png" alt="Starlight" width="16" height="16">Starlight</a> Sidebar Topics plugins to show a list of topics on desktop and a dropdown menu in the mobile sidebar.
authors:
    - hideoo
    - trueberryless
cover:
