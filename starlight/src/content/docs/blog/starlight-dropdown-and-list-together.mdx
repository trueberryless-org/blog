...
tags:
    ...
    - Topics
    - Plugins
excerpt: Combine two Starlight Sidebar Topics plugins to show a list of topics on desktop and a dropdown menu in the mobile sidebar.
authors:
    - trueberryless
cover:
  alt: A beautiful cover image with the text "Dropdown or List?"
  image: ../../../assets/covers/dropdownandlist.png
---
