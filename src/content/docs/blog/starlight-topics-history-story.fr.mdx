...
authors:
  ...
  - ai
cover:
  alt: Majestic pillars stand in the courtyard of an ancient temple, showcasing
...
Créateur de l'image de couverture : [https://unsplash.com/@nakkeeran\_raveendran](https://unsplash.com/@nakkeeran_raveendran)
