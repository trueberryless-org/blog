...
:::caution
This is a destructive action. Therefore I included a safe guard by lowercasing the `-d` parameter. If your branches are not cleanly merged, git will not delete them. If you are absolutely sure to delete all those branches no matter what, use `-D` instead.
:::
