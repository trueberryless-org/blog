...
![Screenshot of the Visual Studio Code editor, displaying generated content from a code snippet.  ](../../../assets/blog/vscode-snippets/screenshot-triggering-ffmt-snippet.png)
