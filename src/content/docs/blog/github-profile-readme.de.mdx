...
authors:
  - trueberryless
cover:
  alt: Visual representation of git history with contributions stats, featuring
    text highlighted in green and blue for clarity.
...
Ersteller des Titelbildes: [https://unsplash.com/@yancymin](https://unsplash.com/@yancymin)
