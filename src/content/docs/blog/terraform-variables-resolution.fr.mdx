...
authors:
  - trueberryless
cover:
  alt: A wooden church building perched on a hill, symbolizing stability and
    faith, akin to resolving variables in Terraform.
...
Exemple de Résolution des Variables Terraform

## Crédits

Créateur de l'image de couverture : [https://unsplash.com/@pablocontreras](https://unsplash.com/@pablocontreras)
