...
authors:
  - trueberryless
cover:
  alt: A massive container ship with stacked cargo containers sailing across the ocean under a clear blue sky.
...
Cover image creator: https://unsplash.com/@carrier_lost
