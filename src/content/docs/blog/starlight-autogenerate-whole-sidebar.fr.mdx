...
Avez-vous déjà souhaité simplifier la génération des barres latérales dans votre projet [Starlight](https://starlight.astro.build) ? Avez-vous essayé de générer automatiquement toute la barre latérale pour découvrir qu'elle ne permet pas de personnaliser la structure selon vos besoins ?
