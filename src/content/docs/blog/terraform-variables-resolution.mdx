...
After some struggling to keep it going my tokens were all used and I had to figure out the remaining code myself. Nonetheless, I managed to get a running version since not much was missing and immediately realised some improvements that went unnoticed until now. Since I had to wait for my tokens to refill, I did exactly this.
...
![Terraform Variables Resolution Example](../../../assets/blog/terraform-variables-resolution/example.png)

## Credits

Cover image creator: https://unsplash.com/@pablocontreras
