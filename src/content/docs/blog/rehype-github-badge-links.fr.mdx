...
Avec un peu de style supplémentaire, cela devient vraiment mignon à mon avis. Veuillez noter que comme il s'agit d'une page [Starlight](https://starlight.astro.build), j'utilise des variables CSS disponibles, comme à la ligne quatre :
