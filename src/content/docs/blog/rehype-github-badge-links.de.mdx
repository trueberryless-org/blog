...
cover:
  alt: A backpack covered in an assortment of badges, each representing unique
...
Mit ein wenig zusätzlichem Styling sieht es meiner Meinung nach wirklich süß aus. Bitte beachten Sie, dass dies eine [Starlight](https://starlight.astro.build)-Seite ist, bei der ich verfügbare CSS-Variablen verwende, wie in Zeile vier:
