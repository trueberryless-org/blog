...
authors:
  - trueberryless
cover:
  alt: A person balances on a large pipe, with a view of the landscape in the
    background.
...
Cover-Bildersteller: [https://unsplash.com/@frostroomhead](https://unsplash.com/@frostroomhead)
