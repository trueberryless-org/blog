...
authors:
  - trueberryless
cover:
  alt: An elegant pocket watch placed on a book, highlighting the contrast between
    the timepiece and the textured pages.
...
Créateur de l'image de couverture : [https://unsplash.com/@mboulden](https://unsplash.com/@mboulden)
