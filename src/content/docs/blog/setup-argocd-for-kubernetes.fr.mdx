...
authors:
  - trueberryless
cover:
  alt: A massive container ship with stacked cargo containers sailing across the
    ocean under a clear blue sky.
...
Créateur de l'image de couverture : [https://unsplash.com/@carrier\_lost](https://unsplash.com/@carrier_lost)
