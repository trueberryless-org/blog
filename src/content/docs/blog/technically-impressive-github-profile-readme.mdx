...
authors:
  ...
  - ai
cover:
  alt: Overhead perspective of a soccer field with two prominent lines delineating the field boundaries.
  image: ../../../../public/blog/technically-impressive-github-profile-readme.jpg
---

:::note
Read the more formal story [here](/blog/github-profile-readme/)
:::
...
At first, I thought this was fine. It showed everything about me, right? But one day, I looked at it and realised:
...
![Throw away a good idea](../../../assets/blog/technically-impressive-github-profile-readme/online-classes-throw-away.gif)

## Phase 5: SVGs Within SVGs Within SVGs (Inception Level 100)

When I came back to the project, I was **determined** to make it work.

I realised that if I couldn't directly embed HTML into Markdown, I could fake it by using nested SVGs. (btw this is massively simplified; the actual process took days that felt like weeks if not months, but I know that you wouldn't read any of this anyway so who cares?)
...
Cover image creator: https://unsplash.com/@eduardoflorespe
