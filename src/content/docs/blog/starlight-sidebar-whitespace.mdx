...
authors:
  - trueberryless
cover:
  alt: An abstract artwork showcasing a blend of orange, blue, and yellow hues, creating a lively and colorful composition.
...
![Default styling of the Starlight sidebar](../../../assets/blog/starlight-sidebar-whitespace/no-css.png)
...
![Starlight sidebar where the margin between root-level items is smaller](../../../assets/blog/starlight-sidebar-whitespace/whitespaces.png)
...
![Starlight sidebar with lighter font weight](../../../assets/blog/starlight-sidebar-whitespace/font-weight.png)
...
![Starlight sidebar with dimmer colors](../../../assets/blog/starlight-sidebar-whitespace/color.png)
...
![Starlight sidebar with smaller font size](../../../assets/blog/starlight-sidebar-whitespace/font-size.png)
...
Cover image creator: https://unsplash.com/@steve_j
